...
import { DownArrowNoTailOutlineBold, IconDownload, IconSearchFilledRounded, IconSearchOutlined, IconWorkFilled } from "../../../assets/icons/Fluent";
        ...
        <Grid.Col span={16} className="">
          <Stack className="gap-4 ">
            ...
            <Stack className="w-[85%] mt-4">
              ...
              <Group className="self-start mr-6">
                <Button1 label="cv" icon={<IconDownload color="white" className="self-center mt-[2px]" size={22} />} />
                <Button1 label="more" icon={<IconSearchFilledRounded color="white" className="self-center" size={21} />} />
              </Group>
            </Stack>
