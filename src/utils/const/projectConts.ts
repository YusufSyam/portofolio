...
export const CProjects: Array<ICProjects> = [
  {
    ...
    articleLink: "https://repository.unhas.ac.id/id/eprint/44377/",
    summary:
      "PlateWatch is a vehicle license plate detection system developed using YOLOv8, designed to identify odd and even-numbered license plates in real-time. The system utilizes deep learning models to accurately detect and classify vehicles based on the number of their plates. This project involves both backend and frontend development, where the backend handles the machine learning inference process, while the frontend displays the results via a user-friendly web interface. The main goal of PlateWatch is to support traffic management systems by automating the identification of vehicles based on their license plates. The system helps in monitoring vehicle traffic for applications such as toll collection, parking management, and vehicle restriction enforcement. By using YOLOv8, the project ensures high accuracy and speed in detecting license plates, even in challenging environments. This project provides an efficient and scalable solution to enhance traffic-related operations and serves as a valuable tool for city planning and management. This project was developed as part of my undergraduate thesis for a Bachelor's degree in Computer Science.",
    role: [
      "Frontend Developer",
      "Backend Developer",
